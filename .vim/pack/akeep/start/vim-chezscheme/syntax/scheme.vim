...
if exists('g:is_r7rs') || exists('b:is_r7rs')
  syn match schemeBoolean /#t\(rue\)\?/
  syn match schemeBoolean /#f\(alse\)\?/
else
  syn match schemeBoolean /#t/
  syn match schemeBoolean /#f/
endif
...
if exists('g:is_r7rs') || exists('b:is_r7rs')
  ...
  syn keyword schemeSyntax force
  ...
  syn keyword schemeSyntax with-syntax
...
if exists('b:is_chezscheme') || exists('g:is_chezscheme')
  exe 'ru! syntax/chezscheme.vim'
endif
