...
require('nvim-treesitter.configs').setup {
  ensure_installed = {
    "bash", "bibtex", "c", "clojure", "cmake", "cpp", "css", "dot", "elm",
    "haskell", "help", "html", "javascript", "json", "latex", "llvm", "lua",
    "make", "markdown", "ocaml", "python", "racket", "ruby", "rust", "scala",
    "scheme", "swift", "toml", "typescript", "vim"
  },
  auto_install = true,
